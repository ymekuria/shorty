...
var createShortUrl = function (longUrl) { return __awaiter(void 0, void 0, void 0, function () {
    var shortUrl, newLink, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                // create a new shortUrl and add to db if not in cache
                shortUrl = nanoid_1.nanoid(8);
                /*
               ...
               */
                ...
                return [4 /*yield*/, __1.prisma.link.create({
                        data: {
                            longUrl: longUrl,
                            shortUrl: shortUrl
                        },
            ...
            case 1:
                ...
                return [4 /*yield*/, redis_1.setValue(longUrl, newLink.shortUrl)];
            case 2:
                _a.sent();
                console.log(longUrl + " : " + newLink.shortUrl + " added to cache");
                _a.label = 3;
            case 3: return [2 /*return*/, newLink === null || newLink === void 0 ? void 0 : newLink.shortUrl];
            case 4:
                error_1 = _a.sent();
                console.log('error');
                return [3 /*break*/, 5];
